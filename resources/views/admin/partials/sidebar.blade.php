...
<aside class="w-20 lg:w-64 h-full bg-[#0a1d37] flex flex-col shrink-0 transition-all duration-300 z-40">
    ...
    <nav class="flex-1 px-3 space-y-2 overflow-y-auto">
        ...
        <a href="{{ route('admin.agent-chat.index') }}" 
           class="flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all group {{ request()->routeIs('admin.agent-chat.*') ? 'bg-red-600 text-white shadow-lg shadow-red-900/40' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            <svg class="w-6 h-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
