        ...
        <div class="flex items-center gap-4">
            ...
            <div x-show="isAuthenticated" 
                ...
                <div x-show="open" @click.away="open = false" x-cloak
                     ...
                     class="absolute right-0 top-[calc(100%+12px)] w-48 bg-white rounded-2xl shadow-xl border border-slate-100 py-2 z-50 origin-top-right">
    ...
    <main class="flex-1 w-full max-w-7xl mx-auto">
        ...
        <section id="solusi" class="py-20 px-4 md:px-6 bg-white rounded-[3rem] shadow-sm border border-slate-100 mb-20 overflow-hidden">
            <div class="text-center max-w-3xl mx-auto mb-16 space-y-4" data-aos="fade-up">
                ...
                <p class="text-slate-500 font-medium text-sm">Kami menyediakan semua instrumen yang Anda butuhkan untuk memulai bisnis with mudah.</p>
            </div>
...
>>>>>>> e0ed39d (menambahkan button dibagian youtube dan jadwal seminar)
