...
<body class="bg-white text-slate-900 antialiased overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="#home" class="text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors">Beranda</a>
                    <a href="#solusi" class="text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors">Solusi</a>
                    <a href="#produk" class="text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors">Produk</a>
                    <a href="#tentang" class="text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors">Tentang Kami</a>
                </div>

                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.login') }}" class="text-sm font-bold text-slate-600 hover:text-slate-900">Admin Login</a>
                    <a href="{{ route('chat.init') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-blue-600/20 transition-all transform hover:scale-105 active:scale-95">
                        Mulai Chat
                    </a>
                </div>
            </div>
    ...
    <section id="home" class="pt-40 pb-20 px-4">
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div class="space-y-8">
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-600">
            ...
            <div class="relative">
                <div class="relative z-10 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-blue-600/10 border-8 border-white">
    ...
    <section id="solusi" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <!-- Card 1 -->
                <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-transparent hover:border-blue-100 transition-all group hover:-translate-y-2">
                    ...
                    <ul class="space-y-3 text-sm font-bold text-slate-600">
                        <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 rounded-full bg-blue-600"></div> Real-time Monitoring</li>
                        <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 rounded-full bg-blue-600"></div> Integrasi WhatsApp</li>
                    </ul>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 bg-[#0a1d37] rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div class="space-y-8">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ route('chat.init') }}" class="px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold shadow-xl hover:bg-blue-700 transition-all transform hover:scale-105">
                            Hubungi CS Sekarang
                        </a>
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium text-slate-500">
                        ...
                        <li><a href="{{ route('chat.init') }}" class="hover:text-blue-600 transition-colors">Live Chat</a></li>
                    </ul>
                </div>
                <div>
