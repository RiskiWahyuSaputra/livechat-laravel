...
<body class="bg-white text-slate-900 antialiased overflow-x-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center nav-inner h-20">
                ...
                <div class="hidden md:flex items-center gap-8 nav-links">
                    ...
                    <a href="#solusi"
                        class="text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors">Solusi</a>
                    <a href="#produk"
                        class="text-sm font-bold text-slate-600 hover:text-blue-600 transition-colors">Produk</a>
                    <a href="#tentang"
                        class="text-sm font-bold text-slate-600 hover :text-blue-600 transition-colors">Tentang Kami</a>
                </div>

                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.login') }}"
                        class="text-sm font-bold text-slate-600 hover:text-slate-900">Admin Login</a>
                    <a href="{{ route('chat.init') }}"
                        class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-full text-sm font-bold shadow-lg shadow-blue-600/20 transition-all transform hover:scale-105 active:scale-95">
                        Mulai Chat
                    </a>
                </div>
            </div>
    ...
    <section id="home" class="pt-40 pb-20 px-4">
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div class="space-y-8">
                <div
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-600">
                ...
                <h1 class="text-5xl md:text-7xl font-extrabold text-[#0a1d37] leading-[1.1] tracking-tight">
                    Solusi Cerdas untuk <span class="text-blue-600">Pertumbuhan</span> Bisnis Anda.
                </h1>

                <p class="text-lg text-slate-500 font-medium leading-relaxed max-w-xl">
                    BEST CORPORATION menghadirkan ekosistem digital dan produk inovatif yang dirancang untuk membantu
                    masyarakat meraih kebebasan finansial melalui sistem syariah yang berkah.
                </p>

                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('chat.init') }}"
                        class="px-8 py-4 bg-[#0a1d37] text-white rounded-2xl font-bold shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-1">
                        Konsultasi Gratis
                    </a>
                    <a href="#solusi"
                        class="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-2xl font-bold hover:bg-slate-50 transition-all transform hover:-translate-y-1">
            ...
            <div class="relative">
                <div
                    class="relative z-10 rounded-[2.5rem] overflow-hidden shadow-2xl shadow-blue-600/10 border-8 border-white">
                    <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=1200"
                        alt="Team Best Corp" class="w-full h-full object-cover">
                </div>
                <!-- Floating Card -->
                <div
                    class="absolute -bottom-6 -left-6 z-20 bg-white p-6 rounded-3xl shadow-2xl border border-slate-100 max-w-[240px] animate-bounce-slow">
                    ...
                    <p class="text-xs text-slate-500 leading-relaxed">Membangun ekonomi umat dengan cara yang benar dan
                        transparan.</p>
                </div>
            </div>
        </div>
    ...
    <section id="solusi" class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center max-w-3xl mx-auto mb-16 space-y-4">
                <h2 class="text-xs font-bold text-blue-600 uppercase tracking-[0.3em]">Mengapa Memilih Kami</h2>
                <h3 class="text-4xl md:text-5xl font-extrabold text-[#0a1d37] tracking-tight">Ekosistem Lengkap untuk
                    Kesuksesan Anda.</h3>
                <p class="text-slate-500 font-medium">Kami menyediakan semua instrumen yang Anda butuhkan untuk memulai
                    dan mengembangkan bisnis dengan dukungan penuh.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                <!-- Card 1 -->
                <div
                    class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-transparent hover:border-blue-100 transition-all group hover:-translate-y-2">
                    <div
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6">Kelola seluruh bisnis Anda dari genggaman
                        tangan dengan aplikasi dashboard yang modern dan informatif.</p>
                    <ul class="space-y-3 text-sm font-bold text-slate-600">
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-blue-600"></div> Real-time Monitoring
                        </li>
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-blue-600"></div> Integrasi WhatsApp
                        </li>
                    </ul>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6">Bergabunglah dengan ratusan ribu mitra
                        lainnya dan dapatkan bimbingan intensif dari para mentor berpengalaman.</p>
                    <ul class="space-y-3 text-sm font-bold text-slate-600">
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-blue-600"></div> Webinar Mingguan
                        </li>
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-blue-600"></div> Grup Support 24/7
                        </li>
                    </ul>
                </div>
                ...
                <div
                    class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-transparent hover:border-blue-100 transition-all group hover:-translate-y-2">
                    <div
                        class="w-14 h-14 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <p class="text-slate-500 text-sm leading-relaxed mb-6">Produk yang kami pasarkan telah melalui
                        riset mendalam, memiliki sertifikasi BPOM/MUI, dan sangat diminati pasar.</p>
                    <ul class="space-y-3 text-sm font-bold text-slate-600">
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-emerald-600"></div> Standar Industri
                        </li>
                        <li class="flex items-center gap-2">
                            <div class="w-1.5 h-1.5 rounded-full bg-emerald-600"></div> Sertifikasi Lengkap
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <section id="produk" class="py-24">
        <div class="max-w-7xl mx-auto px-4 bg-[#0a1d37] rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
            <div
                class="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-blue-600/20 to-transparent pointer-events-none">
            </div>

            <div class="grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div class="space-y-8">
                    <h3 class="text-4xl md:text-5xl font-extrabold text-white leading-tight">Mulai Perjalanan
                        Kesuksesan Anda Hari Ini.</h3>
                    <p class="text-slate-300 text-lg">Jangan tunda lagi untuk meraih kehidupan yang lebih baik. Kami
                        siap mendampingi setiap langkah Anda.</p>
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ route('chat.init') }}"
                            class="px-8 py-4 bg-blue-600 text-white rounded-2xl font-bold shadow-xl hover:bg-blue-700 transition-all transform hover:scale-105">
                            Hubungi CS Sekarang
                        </a>
                        <a href="#tentang"
                            class="px-8 py-4 bg-white/10 text-white border border-white/20 rounded-2xl font-bold hover:bg-white/20 transition-all">
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-16">
                <div class="col-span-2 space-y-6">
                    <div class="flex items-center gap-3">
                        <img src="{{ asset('images/logo-brilian-min2.png') }}" alt="Logo"
                            class="w-10 h-10 object-contain">
                        <span class="text-2xl font-extrabold tracking-tighter text-slate-900">BRILLIAN <span
                                class="text-blue-600">CORP</span></span>
                    </div>
                    <p class="text-slate-500 font-medium max-w-sm">
                        BRILLIAN.BIS menghadirkan solusi cerdas untuk pertumbuhan bisnis Anda melalui ekosistem digital
                        yang modern dan syariah.
                    </p>
                    <div class="flex gap-4">
                        <div
                            class="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center text-slate-600 hover:bg-blue-600 hover:text-white transition-colors cursor-pointer">
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium text-slate-500">
                        ...
                        <li><a href="#solusi" class="hover:text-blue-600 transition-colors">Solusi Bisnis</a></li>
                        <li><a href="#produk" class="hover:text-blue-600 transition-colors">Produk Unggulan</a></li>
                        <li><a href="{{ route('chat.init') }}" class="hover:text-blue-600 transition-colors">Live
                                Chat</a></li>
                    </ul>
                </div>
                <div>
    ...
    <a href="{{ route('chat.init') }}"
        ...
        <!-- Tooltip -->
        <span
            class="absolute right-20 bg-[#0a1d37] text-white text-[10px] font-bold py-2 px-4 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl pointer-events-none uppercase tracking-widest">
            Chat dengan CS Kami
        </span>
    </a>
